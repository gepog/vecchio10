    ...
    movies: [
      {
        ...
        description: 'How Bolt.new Is Changing Creative Workflows. Why you should start building ideas instead of wasting time searching. Every day, creators and teams spend hours looking for workflows, content inspiration, scripts, or tools. Bolt.new offers a radical alternative: stop searching—start building.',
      ...
      },
      {
        ...
        id: 'trending-2',
        title: 'No-Code Power',
        description: 'Pro Results, No Code Needed. Drag-and-drop tools to build powerful solutions with zero coding. Bolt.new features a visual builder where you can combine AI blocks, text, automations, and interactive videos using an intuitive interface.',
      ...
      },
      {
        ...
        description: 'Bolt.new and Creative Team Collaboration. A platform where every idea can be iterated together. On Bolt.new, collaboration is not an afterthought—it\'s native. Projects can be cloned by teammates, edited in parallel, commented on, and reviewed without conflict.',
      ...
      },
      {
        ...
        description: 'What\'s Hot in the Bolt.new Community. See which prompt chains are trending and why. The Trending section on Bolt.new highlights the most cloned and personalized AI ideas. But it\'s not just a list of likes—each prompt shows clone rates, average editing time, and content type.',
      ...
      },
      {
        ...
        description: 'Hackathon Project Idea of the Day. Prompt-to-Video Generator for Startups. Here\'s a powerful idea: a tool that converts a single text prompt into a short AI-generated pitch or demo video. Bolt.new can string together script generation, voiceover, visual blocks, and music modules.',
      ...
      },
      {
        ...
        description: 'Tip of the Day. Test More Ideas Using Variants. You often think of multiple tones: formal, playful, technical. With Bolt.new, you can duplicate a page or flow to test different versions in parallel. It\'s ideal for A/B testing, client reviews, or creative exploration.',
      ...
      },
      {
        ...
        description: 'Trending / Favourites. Fastest-Growing Prompt Chains This Week. According to analytics, the most cloned projects this week involve email automation, creator monetization, and educational tools. These aren\'t just popular—they have high engagement and reuse.',
      ...
      },
      {
        ...
        id: 'trending-8',
        title: 'API Import',
        description: 'Product & Technical – Update. New API for Importing External Prompt Chains. Bolt.new now lets users link prompt chains from external tools—like Notion, ChatGPT, or internal systems—directly into a project. This unlocks true modular creativity.',
