    ...
    movies: [
      {
        ...
        description: 'Build intelligent automation workflows with drag-and-drop simplicity. Connect APIs, process data, and create powerful AI-driven solutions without coding.',
      ...
      },
      {
        ...movies[1],
        id: 'trending-2',
        title: 'Import & Integration Hub',
        description: 'Seamlessly import data from multiple sources and integrate with your favorite tools. Transform your workflow with powerful connection capabilities.',
      ...
      },
      {
        ...
        description: 'Discover the most popular AI prompt chains and automation templates. Learn from the community and accelerate your productivity.',
      ...
      },
      {
        ...
        description: 'Track your automation performance with comprehensive analytics. Monitor success rates, optimize workflows, and maximize your ROI.',
      ...
      },
      {
        ...movies[4],
        id: 'trending-5',
        title: 'Text-to-Media Generator',
        description: 'Transform text prompts into rich media content. Generate videos, audio, and interactive content with advanced AI processing.',
      ...
      },
      {
        ...
        description: 'Create and connect intelligent AI modules with visual programming. Build complex neural networks that power your automation workflows.',
      ...
      },
      {
        ...
        description: 'Seamlessly synchronize your workflows across tablets, phones, and desktops. Access your automation tools anywhere, anytime.',
      ...
      },
      {
        ...movies[7],
        id: 'trending-8',
        title: 'Formal vs Playful AI',
        description: 'Choose between formal business automation and playful creative workflows. Customize your AI personality to match your project needs.',
